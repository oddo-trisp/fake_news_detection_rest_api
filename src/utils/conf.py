...
MAE_TRAINING_FILE = 'mae_training'
MAE_TESTING_FILE = 'mae_testing'
...
MAE_TRAINING_PLOT_PATH = OUTPUT_PATH + MAE_TRAINING_FILE
MAE_TESTING_PLOT_PATH = OUTPUT_PATH + MAE_TESTING_FILE
...
DEEP_LEARNING_FEATURE_SET = {W2V, ONE_HOT}
